...
MODULE_PERMISSIONS = {
    ...
    'multientity': {
        ...
        'resources': {
            'dashboard': ['view'],
            'overview': ['view'],
            'groups': ['view', 'create', 'edit', 'delete', 'archive', 'restore'],
            'entities': ['view', 'create', 'edit', 'delete', 'archive', 'restore'],
            'branches': ['view', 'create', 'edit', 'delete', 'archive', 'restore'],
            'sites': ['view', 'create', 'edit', 'delete', 'archive', 'restore'],
            'relationships': ['view', 'create', 'edit', 'delete'],
            'shared_rules': ['view', 'create', 'edit', 'delete'],
            'intercompany': ['view', 'create', 'edit', 'delete'],
            'access': ['view', 'create', 'edit', 'delete', 'revoke'],
            'scopes': ['view', 'create', 'edit', 'delete'],
            'numbering': ['view', 'create', 'edit', 'delete'],
            'audit': ['view', 'export'],
            'reports': ['view', 'export'],
            'export': ['view', 'export'],
            'settings': ['view', 'edit'],
    ...
    'wms': {
        ...
        'resources': {
            ...
            'receiving': ['view', 'create', 'edit', 'receive', 'approve'],
            'asn': ['view', 'create', 'edit', 'approve'],
            'cross_dock': ['view', 'create', 'edit'],
            'shipments': ['view', 'create', 'edit', 'pick', 'pack', 'ship', 'approve'],
            'putaway': ['view', 'create', 'edit', 'complete', 'cancel'],
            'picking': ['view', 'create', 'edit', 'delete', 'approve', 'short'],
            'packing': ['view', 'create', 'edit', 'complete'],
            'dispatch': ['view', 'create', 'edit', 'ship', 'gate_out'],
            'waves': ['view', 'create', 'edit', 'approve', 'release', 'cancel'],
            'replenishment': ['view', 'create', 'edit', 'approve', 'execute'],
            'returns': ['view', 'create', 'edit', 'approve'],
            'transfers': ['view', 'create', 'edit', 'approve', 'execute'],
            'adjustments': ['view', 'create', 'edit', 'approve'],
            'quality': ['view', 'create', 'edit', 'approve', 'release'],
            'qc': ['view', 'create', 'edit', 'inspect'],
            'aql': ['view', 'create', 'edit', 'delete'],
            'defect_codes': ['view', 'create', 'edit', 'delete'],
            'capa': ['view', 'create', 'edit', 'approve'],
            'certificates': ['view', 'create', 'edit', 'delete'],
            'holds': ['view', 'create', 'edit', 'release'],
            'yard': ['view', 'create', 'edit', 'arrive', 'depart'],
            'dock_doors': ['view', 'create', 'edit', 'assign'],
            'labor': ['view', 'create', 'edit', 'assign'],
            'rf_scan': ['view', 'create', 'edit', 'scan'],
            'voice_picking': ['view', 'create', 'edit', 'start', 'confirm'],
            'edi': ['view', 'create', 'edit', 'approve', 'send'],
            'reports': ['view', 'export'],
            'settings': ['view', 'edit'],
        }
    },
    ...
    'security': {
        'label': 'Security / SSO / MFA',
        'resources': {
            'view': ['view'],
            'admin': ['view', 'manage'],
            'mfa': ['view', 'manage', 'enroll', 'disable'],
            'sso': ['view', 'manage', 'create', 'edit', 'delete', 'test'],
            'sessions': ['view', 'revoke'],
            'policies': ['view', 'edit'],
            'audit': ['view', 'export'],
            'alerts': ['view', 'manage', 'acknowledge', 'resolve'],
            'reports': ['view', 'export'],
            'access_reviews': ['view', 'manage', 'create', 'approve', 'revoke'],
            'role_conflicts': ['view', 'manage', 'waive'],
            'breakglass': ['view', 'use', 'manage'],
            'api_security': ['view', 'manage'],
            'settings': ['view', 'edit'],
            'emergency_access': ['view', 'use', 'manage', 'approve'],
        }
    },
    'reports': {
        'label': 'Reporting & BI',
    ...
    'ecommerce': {
        ...
        'resources': {
            'dashboard': ['view'],
            'executive_dashboard': ['view'],
            'channels': ['view', 'create', 'edit', 'delete', 'connect', 'disconnect', 'test'],
            'catalog': ['view', 'create', 'edit', 'delete', 'publish', 'unpublish'],
            'orders': ['view', 'create', 'edit', 'delete', 'import', 'export', 'retry', 'approve', 'cancel', 'ship', 'deliver'],
            'inventory': ['view', 'create', 'edit', 'delete', 'sync', 'export', 'configure'],
            'customers': ['view', 'create', 'edit', 'delete', 'sync', 'merge', 'export', 'link'],
            'mappings': ['view', 'create', 'edit', 'delete', 'bulk_create', 'export'],
            'pricing': ['view', 'create', 'edit', 'delete', 'approve', 'export'],
            'promotions': ['view', 'create', 'edit', 'delete', 'approve', 'export'],
            'fulfillment': ['view', 'create', 'edit', 'delete', 'approve', 'ship', 'return', 'refund'],
            'returns': ['view', 'create', 'edit', 'delete', 'approve', 'receive'],
            'refunds': ['view', 'create', 'edit', 'delete', 'approve', 'process'],
            'exceptions': ['view', 'create', 'edit', 'delete', 'resolve', 'approve', 'export', 'escalate'],
            'analytics': ['view', 'export', 'configure'],
            'reports': ['view', 'export', 'schedule', 'configure'],
            'crm_linkage': ['view', 'link', 'unlink', 'export'],
            'workflow': ['view', 'approve', 'reject', 'delegate', 'escalate'],
            'settings': ['view', 'edit', 'configure'],
            'audit_logs': ['view', 'export', 'clear'],
            'sync': ['view', 'create', 'edit', 'delete', 'execute', 'cancel', 'retry'],
        }
    },
    'finance': {
        ...
        'resources': {
            'dashboard': ['view'],
            'overview': ['view'],
            'accounts': ['view', 'create', 'edit', 'delete', 'transfer', 'reconcile'],
            'income': ['view', 'create', 'edit', 'delete'],
            'expenses': ['view', 'create', 'edit', 'delete', 'flag'],
            'transactions': ['view', 'create', 'edit', 'delete', 'confirm', 'flag', 'bulk_edit', 'split'],
            'budgets': ['view', 'create', 'edit', 'delete', 'approve'],
            'goals': ['view', 'create', 'edit', 'delete', 'achieve'],
            'savings': ['view', 'create', 'edit', 'delete', 'transfer'],
            'investments': ['view', 'create', 'edit', 'delete', 'dispose'],
            'debts': ['view', 'create', 'edit', 'delete', 'pay'],
            'assets': ['view', 'create', 'edit', 'delete', 'dispose'],
            'subscriptions': ['view', 'create', 'edit', 'delete', 'cancel'],
            'calendar': ['view', 'create', 'edit', 'delete'],
            'alerts': ['view', 'create', 'edit', 'delete', 'dismiss', 'read'],
            'categories': ['view', 'create', 'edit', 'delete', 'merge'],
            'reports': ['view', 'export', 'schedule'],
            'analysis': ['view'],
            'automation': ['view', 'create', 'edit', 'delete', 'trigger'],
            'documents': ['view', 'create', 'edit', 'delete', 'attach'],
            'currencies': ['view', 'create', 'edit', 'delete'],
            'family': ['view', 'create', 'edit', 'delete', 'invite'],
            'cash_flow': ['view'],
            'settings': ['view', 'edit'],
            'import': ['view', 'create', 'execute', 'validate'],
            'export': ['view', 'execute'],
            'audit_logs': ['view', 'export'],
        }
    },
    'grc': {
        ...
        'resources': {
            'dashboard': ['view'],
            'governance': ['view', 'create', 'edit', 'delete', 'manage'],
            'governance_entities': ['view', 'create', 'edit', 'delete', 'manage'],
            'risks': ['view', 'create', 'edit', 'delete', 'approve', 'manage'],
            'risk_assessments': ['view', 'create', 'edit', 'delete', 'approve'],
            'risk_treatments': ['view', 'create', 'edit', 'delete', 'approve'],
            'controls': ['view', 'create', 'edit', 'delete', 'manage'],
            'control_tests': ['view', 'create', 'edit', 'delete', 'execute', 'review', 'approve'],
            'control_test_results': ['view', 'create', 'edit', 'delete'],
            'obligations': ['view', 'create', 'edit', 'delete', 'manage'],
            'regulations': ['view', 'create', 'edit', 'delete', 'manage'],
            'policies': ['view', 'create', 'edit', 'delete', 'approve', 'manage'],
            'policy_versions': ['view', 'create', 'edit', 'delete', 'approve'],
            'policy_acknowledgements': ['view', 'create', 'edit', 'delete', 'acknowledge', 'manage'],
            'sod': ['view', 'create', 'edit', 'delete', 'manage', 'approve', 'waive'],
            'sod_conflicts': ['view', 'create', 'edit', 'delete', 'resolve', 'approve', 'waive'],
            'access_reviews': ['view', 'create', 'edit', 'delete', 'manage', 'execute', 'approve'],
            'access_review_items': ['view', 'create', 'edit', 'delete', 'approve', 'revoke'],
            'exceptions': ['view', 'create', 'edit', 'delete', 'approve', 'waive'],
            'findings': ['view', 'create', 'edit', 'delete', 'approve', 'close', 'reopen'],
            'remediation': ['view', 'create', 'edit', 'delete', 'approve', 'close'],
            'remediation_tasks': ['view', 'create', 'edit', 'delete', 'complete'],
            'evidence': ['view', 'create', 'edit', 'delete', 'upload', 'download', 'review'],
            'audit_preparedness': ['view', 'create', 'edit', 'delete', 'manage', 'approve'],
            'incidents': ['view', 'create', 'edit', 'delete', 'manage', 'close'],
            'certifications': ['view', 'create', 'edit', 'delete', 'manage', 'renew'],
            'deadlines': ['view', 'create', 'edit', 'delete', 'manage', 'complete'],
            'alert_rules': ['view', 'create', 'edit', 'delete', 'manage', 'activate'],
            'alert_events': ['view', 'acknowledge', 'resolve', 'escalate'],
            'high_risk_events': ['view', 'create', 'edit', 'delete', 'review', 'manage'],
            'approval_matrix': ['view', 'create', 'edit', 'delete', 'manage', 'approve'],
            'framework_templates': ['view', 'create', 'edit', 'delete', 'manage'],
            'entity_links': ['view', 'create', 'edit', 'delete', 'manage'],
            'watchlists': ['view', 'create', 'edit', 'delete', 'manage'],
            'reports': ['view', 'export', 'schedule', 'configure'],
            'export': ['view', 'text_excel', 'general_excel', 'csv', 'pdf'],
            'settings': ['view', 'edit', 'manage', 'configure'],
            'audit_logs': ['view', 'export', 'clear'],
        }
    },
    'legal_tax': {
        'label': 'Legal / Tax Reporting',
        'resources': {
            # Dashboard & Overview
            'dashboard': ['view'],
            'overview': ['view'],
            'filing_calendar': ['view'],

            # Tax Configuration
            'jurisdictions': ['view', 'create', 'edit', 'delete'],
            'authorities': ['view', 'create', 'edit', 'delete'],
            'registrations': ['view', 'create', 'edit', 'delete'],
            'tax_codes': ['view', 'create', 'edit', 'delete'],
            'tax_rules': ['view', 'create', 'edit', 'delete'],
            'filing_periods': ['view', 'create', 'edit', 'delete', 'lock', 'unlock'],

            # Returns & Review
            'returns': ['view', 'create', 'edit', 'delete', 'submit', 'approve', 'reject', 'file'],
            'transaction_review': ['view', 'create', 'edit', 'approve', 'reject'],
            'reconciliations': ['view', 'create', 'edit', 'delete', 'match', 'unmatch'],

            # Obligations & Tasks
            'obligations': ['view', 'create', 'edit', 'delete', 'complete'],
            'compliance_tasks': ['view', 'create', 'edit', 'delete', 'complete', 'close'],

            # Notices & Disputes
            'notices': ['view', 'create', 'edit', 'delete', 'resolve'],
            'penalties': ['view', 'create', 'edit', 'delete', 'pay', 'waive'],
            'disputes': ['view', 'create', 'edit', 'delete', 'resolve', 'appeal'],

            # Audit & Reports
            'audit_packs': ['view', 'create', 'edit', 'delete', 'generate', 'export'],
            'reports': ['view', 'export', 'schedule', 'configure'],
            'export': ['view', 'text_excel', 'general_excel', 'csv', 'pdf', 'json'],

            # Settings
            'settings': ['view', 'edit', 'configure'],
            'sample_data': ['view', 'generate', 'clear'],
    ...
    'integration': {
        ...
        'resources': {
            'dashboard': ['view'],
            'connector': ['view', 'create', 'edit', 'delete', 'activate', 'deactivate', 'test', 'manage'],
            'flow': ['view', 'create', 'edit', 'delete', 'publish', 'archive', 'execute', 'clone'],
            'endpoint': ['view', 'create', 'edit', 'delete', 'test', 'activate', 'deprecate'],
            'webhook': ['view', 'create', 'edit', 'delete', 'activate', 'deactivate', 'replay', 'test'],
            'queue': ['view', 'requeue', 'cancel', 'retry', 'clear'],
            'dlq': ['view', 'replay', 'resolve', 'discard', 'retry'],
            'mapping': ['view', 'create', 'edit', 'delete', 'clone', 'export', 'import'],
            'transform': ['view', 'create', 'edit', 'delete', 'clone', 'export'],
            'credentials': ['view', 'create', 'edit', 'delete', 'test', 'rotate', 'mask'],
            'reconciliation': ['view', 'create', 'edit', 'resolve', 'retry', 'export'],
            'schedule': ['view', 'create', 'edit', 'delete', 'activate', 'deactivate', 'execute'],
            'job_run': ['view', 'execute', 'cancel', 'retry'],
            'file_exchange': ['view', 'create', 'edit', 'delete', 'process', 'retry', 'export'],
            'alert_rule': ['view', 'create', 'edit', 'delete', 'activate', 'deactivate'],
            'alert_event': ['view', 'acknowledge', 'resolve', 'escalate'],
            'event_subscription': ['view', 'create', 'edit', 'delete', 'activate', 'deactivate'],
            'report': ['view', 'export', 'schedule', 'configure'],
            'settings': ['view', 'edit', 'configure', 'manage'],
            'audit': ['view', 'export', 'clear'],
            'admin': ['view', 'access', 'manage', 'configure'],
        }
    },
    'btp': {
        ...
        'resources': {
            'dashboard': ['view'],
            'connector': ['view', 'create', 'edit', 'delete', 'test', 'activate', 'deactivate', 'export'],
            'flow': ['view', 'create', 'edit', 'delete', 'run', 'approve', 'clone'],
            'mapping': ['view', 'create', 'edit', 'delete', 'approve', 'test', 'export'],
            'job': ['view', 'run', 'retry', 'cancel', 'export'],
            'api': ['view', 'client_manage', 'key_manage', 'policy_manage'],
            'event': ['view', 'replay', 'subscribe'],
            'extension': ['view', 'manage', 'create', 'edit', 'delete'],
            'environment': ['view', 'manage', 'create', 'edit'],
            'feature_flag': ['view', 'manage', 'create', 'edit', 'delete', 'toggle'],
            'monitoring': ['view', 'manage'],
            'report': ['view', 'export'],
            'admin': ['access', 'manage'],
            'ai_provider': ['view', 'manage', 'create', 'edit', 'delete', 'test'],
            'ai_copilot': ['view', 'chat'],
            'secret_reference': ['view', 'manage', 'create', 'edit', 'delete'],
            'export': ['view', 'text_excel', 'general_excel'],
        }
    },
    'documents': {
        ...
        'resources': {
            'dashboard': ['view'],
            'files': ['view', 'upload', 'download', 'edit', 'delete', 'share', 'archive', 'print'],
            ...
            'links': ['view', 'create', 'edit', 'delete', 'manage', 'link', 'unlink'],
            ...
            'checkin_checkout': ['view', 'create', 'edit', 'delete', 'manage', 'checkout', 'force_checkin'],
            'linked_records': ['view', 'create', 'edit', 'delete', 'manage'],
            'dispose': ['view', 'create', 'edit', 'delete', 'execute'],
            'legal_hold': ['view', 'create', 'edit', 'delete', 'release'],
            'metadata': ['view', 'create', 'edit', 'delete', 'manage'],
            'comments': ['view', 'create', 'edit', 'delete', 'resolve'],
            'pending_review': ['view', 'create', 'edit', 'approve'],
            'pending_approval': ['view', 'create', 'edit', 'approve', 'reject'],
            'export_center': ['view', 'create', 'edit', 'delete', 'export'],
        }
    },
    'project': {
        ...
        'resources': {
            'dashboard': ['view'],
            'executive_dashboard': ['view'],
            'pmo_workspace': ['view', 'edit', 'configure'],
            'portfolio': ['view', 'create', 'edit', 'delete', 'approve'],
            'intake': ['view', 'create', 'edit', 'delete', 'approve', 'reject'],
            'projects': ['view', 'create', 'edit', 'delete', 'approve', 'archive', 'export'],
            'charter': ['view', 'create', 'edit', 'approve'],
            'wbs': ['view', 'create', 'edit', 'delete', 'approve'],
            'milestones': ['view', 'create', 'edit', 'delete', 'approve', 'signoff'],
            'tasks': ['view', 'create', 'edit', 'delete', 'approve', 'reassign'],
            'resources': ['view', 'create', 'edit', 'delete', 'allocate'],
            'budget': ['view', 'create', 'edit', 'delete', 'approve', 'export'],
            'procurement': ['view', 'create', 'edit', 'delete', 'link', 'unlink'],
            'timesheet': ['view', 'create', 'edit', 'approve', 'submit'],
            'risks': ['view', 'create', 'edit', 'delete', 'mitigate', 'close'],
            'issues': ['view', 'create', 'edit', 'delete', 'resolve', 'escalate', 'close'],
            'changes': ['view', 'create', 'edit', 'delete', 'approve', 'reject'],
            'documents': ['view', 'upload', 'download', 'edit', 'delete', 'share', 'approve'],
            'governance': ['view', 'create', 'edit', 'approve', 'signoff'],
            'reports': ['view', 'export', 'schedule', 'configure'],
            'workflow': ['view', 'approve', 'reject', 'delegate', 'escalate'],
            'settings': ['view', 'edit', 'configure'],
            'audit_logs': ['view', 'export', 'clear'],
